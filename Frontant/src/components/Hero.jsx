...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white via-blue-50/30 to-white pt-10 pb-16 sm:pt-16 sm:pb-20 lg:pt-14 lg:pb-28">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-10 lg:grid-cols-2 items-center">
        ...
        <div className="text-center lg:text-left order-2 lg:order-1">
          ...
          <p className="mt-4 sm:mt-6 text-sm sm:text-base lg:text-lg text-gray-600 max-w-xl mx-auto lg:mx-0 leading-relaxed">
            ...
            <span className="font-semibold text-gray-900"> Coding</span>, prepare for

            <span className="font-semibold text-gray-900"> Government Exams</span>, and unlock

            <span className="font-semibold text-gray-900"> high-paying career opportunities</span>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 mt-6 sm:mt-8 justify-center lg:justify-start">
            ...
            <div className="flex -space-x-3">
              <img className="w-8 h-8 sm:w-10 sm:h-10 border-2 border-white rounded-full" src="https://randomuser.me/api/portraits/men/32.jpg" />
              <img className="w-8 h-8 sm:w-10 sm:h-10 border-2 border-white rounded-full" src="https://randomuser.me/api/portraits/women/44.jpg" />
              <img className="w-8 h-8 sm:w-10 sm:h-10 border-2 border-white rounded-full" src="https://randomuser.me/api/portraits/men/86.jpg" />
            </div>
